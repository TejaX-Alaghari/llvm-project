; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: --prefix-filecheck-ir-name TMP --version 3
...
; CHECK-NEXT:    [[LSR_IV_LCSSA19:%.*]] = phi i64 [ [[LSR_IV2:%.*]], [[IFMERGE_38:%.*]] ]
; CHECK-NEXT:    [[SPLIT16:%.*]] = phi i64 [ [[TMP3:%.*]], [[IFMERGE_38]] ]
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXITSPLITSPLIT]]
; CHECK:       loop.exit.loopexitsplitsplit:
; CHECK-NEXT:    [[INDVARS_IV_LCSSA_PH_PH_PH:%.*]] = phi i64 [ [[LSR_IV_LCSSA19]], [[IFMERGE_38_LOOP_EXIT_LOOPEXITSPLITSPLIT_CRIT_EDGE:%.*]] ], [ [[LSR_IV]], [[LOOP_EXIT_LOOPEXITSPLITSPLITSPLIT:%.*]] ]
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXITSPLIT:%.*]]
; CHECK:       ifmerge.42.loop.exit.loopexitsplit_crit_edge:
; CHECK-NEXT:    [[LSR_IV_LCSSA11:%.*]] = phi i64 [ [[LSR_IV2]], [[IFMERGE_42:%.*]] ]
; CHECK-NEXT:    [[SPLIT11:%.*]] = phi i64 [ [[TMP4:%.*]], [[IFMERGE_42]] ]
...
; CHECK-NEXT:    [[LSR_IV_LCSSA:%.*]] = phi i64 [ [[LSR_IV2]], [[THEN_34:%.*]] ]
; CHECK-NEXT:    [[SPLIT:%.*]] = phi i64 [ [[TMP2:%.*]], [[THEN_34]] ]
; CHECK-NEXT:    [[TMP8:%.*]] = add i64 [[LSR_IV_LCSSA]], -2
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXIT]]
; CHECK:       loop.exit.loopexit:
; CHECK-NEXT:    [[INDVARS_IV_LCSSA_PH:%.*]] = phi i64 [ [[TMP8]], [[THEN_34_LOOP_EXIT_LOOPEXIT_CRIT_EDGE:%.*]] ], [ [[INDVARS_IV_LCSSA_PH_PH]], [[LOOP_EXIT_LOOPEXITSPLIT]] ]
...
; CHECK:       loop.32:
; CHECK-NEXT:    [[LSR_IV2]] = phi i64 [ [[LSR_IV_NEXT:%.*]], [[IFMERGE_46:%.*]] ], [ 2, [[ENTRY:%.*]] ]
; CHECK-NEXT:    [[I1_I64_0:%.*]] = phi i64 [ 0, [[ENTRY]] ], [ [[NEXTIVLOOP_32:%.*]], [[IFMERGE_46]] ]
; CHECK-NEXT:    [[TMP2]] = shl i64 [[I1_I64_0]], 2
; CHECK-NEXT:    [[LSR_IV1]] = add i64 [[LSR_IV2]], -1
; CHECK-NEXT:    [[TMP9:%.*]] = shl nuw nsw i64 [[LSR_IV2]], 2
; CHECK-NEXT:    [[SCEVGEP7:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP9]]
...
; CHECK:       then.34:
; CHECK-NEXT:    [[TMP10:%.*]] = shl nuw nsw i64 [[LSR_IV2]], 2
; CHECK-NEXT:    [[SCEVGEP5:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP10]]
...
; CHECK:       ifmerge.34:
; CHECK-NEXT:    [[TMP3]] = or disjoint i64 [[TMP2]], 2
; CHECK-NEXT:    [[TMP5:%.*]] = shl nuw nsw i64 [[LSR_IV2]], 2
...
; CHECK:       ifmerge.38:
; CHECK-NEXT:    [[TMP4]] = or disjoint i64 [[TMP2]], 3
; CHECK-NEXT:    [[TMP6:%.*]] = shl nuw nsw i64 [[LSR_IV2]], 2
...
; CHECK:       ifmerge.42:
; CHECK-NEXT:    [[TMP7:%.*]] = shl nuw nsw i64 [[LSR_IV2]], 2
...
; CHECK-NEXT:    [[LSR_IV_NEXT]] = add nuw nsw i64 [[LSR_IV2]], 4
