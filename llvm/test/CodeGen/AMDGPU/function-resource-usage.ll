...
; GCN: .set multi_stage_recurse1.num_vgpr, max(48, multi_stage_recurse2.num_vgpr)
; GCN: .set multi_stage_recurse1.num_agpr, max(0, multi_stage_recurse2.num_agpr)
; GCN: .set multi_stage_recurse1.numbered_sgpr, max(34, multi_stage_recurse2.numbered_sgpr)
; GCN: .set multi_stage_recurse1.private_seg_size, 16+max(multi_stage_recurse2.private_seg_size)
; GCN: .set multi_stage_recurse1.uses_vcc, or(1, multi_stage_recurse2.uses_vcc)
; GCN: .set multi_stage_recurse1.uses_flat_scratch, or(0, multi_stage_recurse2.uses_flat_scratch)
; GCN: .set multi_stage_recurse1.has_dyn_sized_stack, or(0, multi_stage_recurse2.has_dyn_sized_stack)
; GCN: .set multi_stage_recurse1.has_recursion, or(1, multi_stage_recurse2.has_recursion)
; GCN: .set multi_stage_recurse1.has_indirect_call, or(0, multi_stage_recurse2.has_indirect_call)
; GCN: TotalNumSgprs: multi_stage_recurse1.numbered_sgpr+extrasgprs(multi_stage_recurse1.uses_vcc, multi_stage_recurse1.uses_flat_scratch, 1)
; GCN: NumVgprs: max(48, multi_stage_recurse2.num_vgpr)
; GCN: ScratchSize: 16+max(multi_stage_recurse2.private_seg_size)
; GCN-LABEL: {{^}}multi_stage_recurse2:
; GCN: .set multi_stage_recurse2.num_vgpr, max(43, 48)
; GCN: .set multi_stage_recurse2.num_agpr, max(0, 0)
; GCN: .set multi_stage_recurse2.numbered_sgpr, max(34, 34)
...
; GCN: .set multi_stage_recurse_noattr1.num_vgpr, max(41, multi_stage_recurse_noattr2.num_vgpr)
; GCN: .set multi_stage_recurse_noattr1.num_agpr, max(0, multi_stage_recurse_noattr2.num_agpr)
; GCN: .set multi_stage_recurse_noattr1.numbered_sgpr, max(57, multi_stage_recurse_noattr2.numbered_sgpr)
; GCN: .set multi_stage_recurse_noattr1.num_named_barrier, max(0, multi_stage_recurse_noattr2.num_named_barrier)
; GCN: .set multi_stage_recurse_noattr1.private_seg_size, 16+max(multi_stage_recurse_noattr2.private_seg_size)
; GCN: .set multi_stage_recurse_noattr1.uses_vcc, or(1, multi_stage_recurse_noattr2.uses_vcc)
; GCN: .set multi_stage_recurse_noattr1.uses_flat_scratch, or(0, multi_stage_recurse_noattr2.uses_flat_scratch)
; GCN: .set multi_stage_recurse_noattr1.has_dyn_sized_stack, or(0, multi_stage_recurse_noattr2.has_dyn_sized_stack)
; GCN: .set multi_stage_recurse_noattr1.has_recursion, or(0, multi_stage_recurse_noattr2.has_recursion)
; GCN: .set multi_stage_recurse_noattr1.has_indirect_call, or(0, multi_stage_recurse_noattr2.has_indirect_call)
; GCN: TotalNumSgprs: multi_stage_recurse_noattr1.numbered_sgpr+extrasgprs(multi_stage_recurse_noattr1.uses_vcc, multi_stage_recurse_noattr1.uses_flat_scratch, 1)
; GCN: NumVgprs: max(41, multi_stage_recurse_noattr2.num_vgpr)
; GCN: ScratchSize: 16+max(multi_stage_recurse_noattr2.private_seg_size)
; GCN-LABEL: {{^}}multi_stage_recurse_noattr2:
; GCN: .set multi_stage_recurse_noattr2.num_vgpr, max(41, 41)
; GCN: .set multi_stage_recurse_noattr2.num_agpr, max(0, 0)
; GCN: .set multi_stage_recurse_noattr2.numbered_sgpr, max(54, 57)
; GCN: .set multi_stage_recurse_noattr2.num_named_barrier, max(0, amdgpu.max_num_named_barrier)
; GCN: .set multi_stage_recurse_noattr2.private_seg_size, 16
; GCN: .set multi_stage_recurse_noattr2.uses_vcc, 1
; GCN: .set multi_stage_recurse_noattr2.uses_flat_scratch, 0
; GCN: .set multi_stage_recurse_noattr2.has_dyn_sized_stack, 0
; GCN: .set multi_stage_recurse_noattr2.has_recursion, 0
; GCN: .set multi_stage_recurse_noattr2.has_indirect_call, 0
